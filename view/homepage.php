  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="#">Phòng trọ Premium</a></li>
        <li><a href="#">Liên hệ</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#"><span class="glyphicon glyphicon-user"></span> Tài khoản</a></li>
        <li><a href="#"><span class="glyphicon glyphicon-shopping-cart"></span> Danh sách yêu thích</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<footer class="container-fluid text-center">
  <p>Trọ Store Copyright</p>  
  <form class="form-inline">Cập nhặt thông tin phòng trọ mới nhất:
